    ...
    <div className="bg-[#222] rounded-t-3xl">
      <div className="flex flex-col md:flex-row justify-between md:px-32 px-5 p-5">
        <div className="w-full md:w-1/4">
          <Link to="/">
            <h1 className="font-semibold text-2xl text-brightRed">LifeFitness</h1>
          </Link>
          <p className="mt-4">
        ...
        <div>
          ...
          <p className="mt-4">Rr.Drita e Pare Istog</p>
        </div>
        <div>
          ...
          <div className="flex flex-row items-center gap-2">
            ...
            <p>LifeFitness@gmail.com</p>
          </div>
        </div>
      </div>
      <div>
        <p className="text-center mt-4">
          @Copyright developed by <span className="text-brightRed">Fidan Halilaj</span> | All rights
          reserved
        </p>
      </div>
    </div>
